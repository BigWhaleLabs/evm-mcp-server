  ...
  server.prompt(
    ...
    'Compare different EVM-compatible networks',
    {
      networkList: z
        .string()
        .describe(
          "Comma-separated list of networks to compare (e.g., 'ethereum,optimism,arbitrum')"
        ),
    },
    ({ networkList }) => {
        ...
        messages: [
          {
            ...
            content: {
              type: 'text',
              text: `Please compare the following EVM-compatible networks: ${networks.join(
                ', '
              )}. Include information about their architecture, gas fees, transaction speed, security, and any other relevant differences.`,
            },
          },
        ],
      }
